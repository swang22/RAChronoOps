...
def make_fig1():
    ...
    rows = [
        ...
        (0.795, "Naive Storage MCS",
                "Proactive discharge; depletes before scarcity",
                C["red"],    "#FFEBEE", "High EUE bias"),
        (0.655, "SOC-Floor Storage MCS",
                "Reserve floor limits proactive discharge",
                C["orange"], "#FFF3E0", "Residual EUE bias"),
        (0.515, "Emergency-Only Storage MCS",
                "Reliability dispatch; discharge only at shortfall",
                C["green"],  "#E8F5E9", "EUE-aligned"),
        (0.375, "Event-Window Storage MCS",
                "Windowed LP around screened scarcity windows",
                C["sky"],    "#E3F2FD", "EUE-aligned"),
        (0.235, "Full-Year ED",
                "Full-year economic dispatch LP · continuous dispatch",
                C["blue"],   "#E8EAF6", "Continuous-dispatch comparison"),
        (0.095, "PCM-UCED",
                "Full-year unit commitment MILP · operational benchmark",
                C["purple"], "#F3E5F5", "Operational benchmark"),
    ]
