...
| Figure file | Source CSVs | Script | Status |
|---|---|---|---|
| `figures/method_hierarchy.pdf/.png` | — (diagram) | 45 | Complete |
| `figures/eue_by_method.pdf/.png` | `paper_tables/paper_storage_method_comparison.csv` | 45 | Complete |
| `figures/runtime_accuracy_frontier.pdf/.png` | `paper_tables/paper_runtime_accuracy.csv` | 45 | Complete |
| `figures/sampling_convergence.pdf/.png` | `sampling_convergence/convergence_aggregate_metrics.csv`, `convergence_errors_vs_full_ed.csv` | 45 | Complete |
| `figures/robustness_eue_error.pdf/.png` | `storage_robustness_sweep/metrics_all.csv` | 45 | Complete |
